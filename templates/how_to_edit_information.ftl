	...
	<title>How Do I Edit Information In VIVO</title>
		...
		<h2><strong>Editing information in VIVO</strong></h2>
			...
			<h3><strong>How do I use VIVO?</strong></h3>
				...
				<p>Visiting <a href="http://vivo.ufl.edu">http://vivo.ufl.edu</a>. Click on a heading -- research, people, organizations -- to start browsing, or enter a search term to start searching.</p>
			...
			<h3><strong>How do I log in to edit my profile</strong></h3>
				...
				<p>Go to <a href="http://vivo.ufl.edu">http://vivo.ufl.edu.</a> On the right side of the scree, there is a box that says "Manage My Page." Click the button that says "Gatorlink Login" and login with your Gatorlink Username and password.</p>
			...
			<h3><strong>How do I become a proxy editor for a department?</strong></h3>
				...
				<p>An authorizing unit chair must first request permissions from <a href="mailto:vivo@uflib.ufl.edu">vivo@uflib.ufl.edu</a>. Please read the VIVO Statement of Responsibility for additional information.</p>
		...
		<h2><strong><u>Search for information in VIVO</u></strong></h2>
			...
			<h3><strong>Do I have to log in to search VIVO?</strong></h3>
				...
				<p>No. Anyone can search any installation of VIVO. You only need to log in to VIVO to edit information.</p>

			<h3><strong>How do I search other installations of VIVO?</strong></h3>

				<p>Anyone can search any installation of VIVO. To view links to the seven consortium VIVOs, go to:</P
				<p><a href="http://vivoweb.org/about">http://vivoweb.org/about</a> and click the university logo of the VIVO you would like to search.</p>

			<h3><strong>How do I search VIVO on my mobile device?</strong></h3>

				<p>VIVO is compatible with smart phones. Simply go to <a href="http://vivo.ufl.edu">http://vivo.ufl.edu</a> on your smart device and search as you would search VIVO on a computer.</p>
