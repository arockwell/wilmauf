...
<#macro loginForm>
    ...
    <section id="login" class="hidden">
        <h2>Manage My Page</h2>
    
	<center>
	<table style="width:95%">
		<tr>
		<td style="width:25%"><img src="/themes/wilmauf/images/profile_thumb.jpg" /></td>
		<td style="text-align:left;vertical-align:top"><p>Log in now to manage your profile page.</p></td>
		</tr>
	</table>
	</center>
	...
	-->
            ...
            <p class="submit" style="visibility:hidden;"><input name="loginForm" type="submit" class="green button" value="Log in"/></p>
